...
# IMPORTANT: If the sript doesn't handle exception the program will terminate abruptly. If the script handles exception the program will run further
# An exception is a signal that a condition has occured that can't be easily handled using the normal flow-of-control of a Python program
